...
public class FTK extends javax.swing.JFrame {
    ...
    public void KetNoiCSDL() {
        try {
            ...
            if (conn != null) {
                ...
                theLoaiCollection = conn.getCollection("TheLoai");
            } else {
    ...
    public void Load_data_TK() {
        try {
            FindIterable<Document> documents = theLoaiCollection.find(); // Lấy tất cả các tài liệu từ collection
            ...
            while (cursor.hasNext()) {
                ...
                v1.add(doc.getString("MaTK"));  // Thay thế bằng tên trường trong MongoDB
                v1.add(doc.getString("TenTK"));
                v1.add(doc.getString("MatKhauTK"));
                v1.add(doc.getString("LoaiTK"));
                v1.add(doc.getString("MaNV"));
                model.addRow(v1);
            }
    ...
    public void Load_data_TK(String MaTK) {
        try {
            Document query = new Document("MaTK", MaTK); // Tạo truy vấn
            FindIterable<Document> documents = theLoaiCollection.find(query); // Tìm tài liệu theo truy vấn
            MongoCursor<Document> cursor = documents.iterator();
    ...
    private void initComponents() {
        ...
        panelBoderFrm1Layout.setVerticalGroup(
            ...
            .addGroup(panelBoderFrm1Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addGroup(panelBoderFrm1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jButtonTim, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
