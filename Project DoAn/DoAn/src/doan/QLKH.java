...
public class QLKH extends javax.swing.JFrame {
     ...
     */
    MongoDatabase conn;
    MongoCollection<Document> theLoaiCollection;
    ...
    public void KetNoiCSDL() {
        try {
            conn = MongoDBConnection.getMongoDBConnection();
            if (conn != null) {
                System.out.print("Kết nối MongoDB thành công");
                theLoaiCollection = conn.getCollection("TheLoai");  // Lấy collection TheLoai từ database
            } else {
                System.out.print("Kết nối MongoDB thất bại");
            }
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jRadioVip.setBackground(new java.awt.Color(255, 255, 255));
        jRadioVip.setText("Thân Thiết");

        jRadioNormal.setBackground(new java.awt.Color(255, 255, 255));
        ...
        JButtonTim.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        ...
        jButtonCapNhat.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButtonCapNhat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/maintenance.png"))); // NOI18N
        jButtonCapNhat.setText("Sửa");
        ...
        jButtonReset.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/broom.png"))); // NOI18N
        ...
        panelBoderFrm7Layout.setHorizontalGroup(
            ...
            .addGroup(panelBoderFrm7Layout.createSequentialGroup()
                ...
                .addGroup(panelBoderFrm7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBoderFrm7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(jButtonCapNhat, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jButtonReset, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)))
